...
export async function handleUIApiRequests(method, pathParam, req, res, currentConfig, providerPoolManager) {
    ...
    // Import Kiro Account Manager Data (full JSON export)
    if (method === 'POST' && pathParam === '/api/kiro/import-manager-data') {
        return await oauthApi.handleImportKiroManagerData(req, res);
    }
